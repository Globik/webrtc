...
```
	...
	WebRTC DataChannel API in action. Based on libjanus_echotest.so
	```
	
	In plans to do the same with a nice [mediasoup.js](https://github.com/versatica/mediasoup) webrtc streaming  solution - server side.
